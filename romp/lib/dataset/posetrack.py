...
def Posetrack(base_class=default_mode):
    class Posetrack(Base_Classes[base_class]):
        ...
        def get_image_info(self,index):
            ...
            kp2ds, track_ids = mindspore.Tensor(kp2ds), mindspore.Tensor(self.annots[img_name][1])
        ...
        def pack_annots(self, ):
            ...
            for annot_path in glob.glob(os.path.join(annots_dir, '*.json')):
                ...
                for index, img_id in enumerate(img_ids):
                    ...
                    annots[file_name] = [joints, mindspore.Tensor(img_person_ids)]
                    if index%1000==0:
        ...
        def get_joints_ids(self, anno):
            ...
            return mindspore.Tensor(joints), track_ids
    return Posetrack
