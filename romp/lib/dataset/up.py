...
def UP(base_class=default_mode):
    class UP(Base_Classes[base_class]):
        ...
        def get_image_info(self,index):
            ...
            params = mindspore.Tensor([np.concatenate([theta, beta])])
            ...
            vmask_3d = mindspore.Tensor([[kp3ds is not None,True,True,False,False,False]])
            ...
            img_info = {'imgpath': imgpath, 'image': image, 'kp2ds': kp2ds, 'track_ids': np.arange(len(kp2ds)),\
                    'vmask_2d': mindspore.Tensor([[True,False,False]]), 'vmask_3d': vmask_3d,\
