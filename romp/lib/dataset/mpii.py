    ...
    class MPII(Base_Classes[base_class]):
        ...
        def load_eft_annots(self, annot_file_path):
            ...
            for eft_data in annots:
                ...
                pred_betas = np.reshape(np.array(eft_data['parm_shape'], dtype=mindspore.float32), (10))  # (10,)
                pred_pose_rotmat = np.reshape(np.array(eft_data['parm_pose'], dtype=mindspore.float32), (24, 3, 3))  # (24,3,3)
