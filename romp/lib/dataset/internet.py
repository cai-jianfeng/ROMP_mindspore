...
import mindspore # import torchvision
...
def img_preprocess(image, imgpath, input_size=512, ds='internet', single_img_input=False):
    ...
    image = mindspore.Tensor.from_numpy(cv2.resize(image_org, (input_size,input_size), interpolation=cv2.INTER_CUBIC))
    #image_1024 = mindspore.Tensor.from_numpy(cv2.resize(image_org, (1024,1024), interpolation=cv2.INTER_CUBIC))
