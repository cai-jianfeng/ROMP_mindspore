...
def MPI_INF_3DHP_TEST(base_class=default_mode):
    class MPI_INF_3DHP_TEST(Base_Classes[base_class]):
        ...
        def get_image_info(self, index):
            ...
            camMats = mindspore.Tensor([[fl, 0, w/2.], [0, fl, h/2.], [0,0,1]])
            ...
            img_info = {'imgpath': imgpath, 'image': image, 'kp2ds': kp2ds, 'track_ids': [self.track_id[subject_id]],\
                    'vmask_2d': mindspore.Tensor([[True,True,True]]), 'vmask_3d': mindspore.Tensor([[True,False,False,False,False,True]]),\
            ...
            if 'relative' in base_class:
                img_info['depth'] = mindspore.Tensor([[0, self.subject_gender[subject_id], 0, 0]])
        ...
        def pack_data(self,annots_file_path):
            ...
            for user_i in user_list:
                ...
                annots_2d = mindspore.Tensor(annotation['annot2'])
                annots_3d = mindspore.Tensor(annotation['annot3'])
                frame_num = annots_3d.shape[-1]
                univ_annot3 = mindspore.Tensor(annotation['univ_annot3'])
