...
class SMPLWrapper(nn.Cell):
    def __init__(self):
        ...
        self.params_num = mindspore.Tensor(self.part_idx).sum()
        self.global_orient_nocam = constants.global_orient_nocam.unsqueeze(0) #mindspore.Tensor.from_numpy(constants.global_orient_nocam).unsqueeze(0)
        self.joint_mapper_op25 = constants.joint_mapping(constants.SMPL_ALL_54, constants.OpenPose_25).long()# mindspore.Tensor.from_numpy(constants.joint_mapping(constants.SMPL_ALL_54, constants.OpenPose_25)).long()
        self.joint_mapper_op25 = constants.joint_mapping(constants.SMPL_ALL_54, constants.OpenPose_25).long()# mindspore.Tensor.from_numpy(constants.joint_mapping(constants.SMPL_ALL_54, constants.OpenPose_25)).long()
