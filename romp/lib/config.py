...
def parse_args(input_args=None):
    ...
    V6_group.add_argument('--focal_length', type=float, default=443.4,
                          help='Default focal length, adopted from JTA dataset')
    V6_group.add_argument('--FOV', type=int, default=60, help='Field of View')
    V6_group.add_argument('--matching_pckh_thresh', type=float, default=0.6,
                          help='Threshold to determine the sucess matching based on pckh')
    ...
    mode_group.add_argument('--image_loading_mode', type=str, default='image',
                            help='The Base Class (image, image_relative) used for loading dataset.')
    ...
    # smpl_group.add_argument('--smpl_model_path',type = str,default = os.path.join(smpl_model_dir,'smpl_packed_info.ckpt'),help = 'smpl model path')
    smpl_group.add_argument('--smpl_model_path', type=str, default=os.path.join(smpl_model_dir, 'smpl_packed_info.pth'),
                            help='smpl model path')
    smpl_group.add_argument('--smpla_model_path', type=str, default=os.path.join(smpl_model_dir, 'SMPLA_NEUTRAL.pth'),
                            help='smpl model path')  # SMPLA_FEMALE gets better MPJPE #smpla_packed_info.pth
    smpl_group.add_argument('--smil_model_path', type=str, default=os.path.join(smpl_model_dir, 'smil_packed_info.pth'),
                            help='smpl model path')
    smpl_group.add_argument('--smpl_prior_path', type=str, default=os.path.join(model_dir, 'parameters', 'gmm_08.pkl'),
                            help='smpl model path')
