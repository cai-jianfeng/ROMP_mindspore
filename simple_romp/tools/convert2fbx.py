...
def process_poses(
    ...
    if len(sequence_results)>0:
        ...
        poses = mindspore.Tensor(sequence_results[subject_id]['smpl_thetas'])
        trans = mindspore.Tensor(sequence_results[subject_id]['cam_trans'])
    else:
    ...
    offset = mindspore.Tensor([0.0, 0.0, 0.0])
